      ...
      <div className="absolute inset-0 z-0">
        ...
        <div className="relative h-full">
          <OptimizedImage
            ...
            aspectRatio="hero"
            priority={true}
            className="object-cover object-[80%_center] md:object-center will-change-transform"
            style={{ 
