  ...
  return (
    <div className={`relative ${aspectRatioClasses[aspectRatio]} ${className}`}>
      <Image
        ...
        blurDataURL={isHero ? "data:image/jpeg;base64," : undefined}
        style={{
          ...props.style,
          ...
          width: '100%',
          height: '100%',
          objectPosition: aspectRatio === 'campaign' ? '50% 50%' : props.style?.objectPosition
        }}
        {...props}
      />
    </div>
